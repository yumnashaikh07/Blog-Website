...
export default async function BlogPostPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <main className="flex flex-col max-w-5xl items-center p-4 mx-auto ">
      ...
      <p className="text-sm mb-4 border-l-2 text-start text-gray-600 pl-3 italic border-gray-500">{post.description}</p>
      ...
      <div className="flex justify-between mx-auto space-x-72 md:space-x-[900px]  mb-20 items-center">
