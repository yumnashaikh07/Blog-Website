...
return(
    ...
    <div className='flex flex-col md:ml-3'>
        ...
        <div className='md:flex md:justify-between grid grid-cols-1 space-x-3'>
            <h3 className='md:text-base text-sm px-3 md:my-0 my-5'>© 2035 by VOID. Powered and secured by <Link href={"https://www.linkedin.com/in/yumna-shaikh-b90191337?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" } className='hover:underline'>RAYS Tech & Design</Link></h3>
      <div className='flex md:justify-between space-x-3'>
            ...
            <FaInstagram size={24} color="white" className='md:ml-[670px] ml-[170px]' />
            </a>
